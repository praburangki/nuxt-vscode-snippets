...
import { generateDocs, populateDocsBlock } from './docs/snippets.ts';
import { variants } from './snippets/index.ts';
import { convertToVscSnippet, generateSnippets, groupSnippets } from './utils/snippet.util.ts';
...
function main() {
  ...
  // Convert VDefinitions to VscDefinitions, for every variant
